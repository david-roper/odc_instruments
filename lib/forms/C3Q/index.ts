...
export default defineInstrument({
  ...
  details: {
    ...
    title: {
      en: 'Communicating Cognitive Challenges in HIV Questionnaire',
      fr: 'Questionnaire sur la communication des difficultés cognitives chez les personnes vivant avec le VIH'
    },
    referenceUrl: 'https://pubmed.ncbi.nlm.nih.gov/33104940/',
    estimatedDuration: 5,
    instructions: {
      en: [
