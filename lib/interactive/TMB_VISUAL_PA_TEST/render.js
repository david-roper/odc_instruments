      ...
      if (tmbUI.status === 'timeout' || !correct) {
        ...
        showAlert(
          translator.t('feedback.pairYouLearned') +
            ...
            "'><br>" +
            '<br>' +
            translator.t('feedback.clickRight') +
            '<br><br>',
      ...
      if (tmbUI.status === 'timeout') {
        ...
        showAlert(
          translator.t('feedback.takingTooLong') +
            '<br>' +
            translator.t('feedback.clickGoesWith') +
            '<br><br>' +
            "<img src='" +
            frame.probe +
    ...
    testMessage = {
      ...
      instructions: [
        ...
        '<h3>' +
          ...
          '<br>' +
          translator.t('test.hintBridge') +
          '<br><br>',
        translator.t('test.excellent') +
          '<br>' +
          tFormat('test.recallAll', { count: imagePairs.length }) +
          '<br>' +
