...
export function render(onComplete) {
  ...
  // language suffix for instruction images ('_en' or '_fr')
  var imgLang = translator.resolvedLanguage === 'fr' ? 'fr' : 'en';
    ...
    TestMessage = {
      ...
      instructions: [
        instructionsHeading +
          ...
          '<br><br>',
        instructionsHeading +
          "<img src='images/Inst2_" +
          imgLang +
          ".jpg' alt='Instructions'><br><br>" +
          translator.t('instructions.step2') +
          '<br><br>',
        instructionsHeading +
          "<img src='images/Inst3_" +
          imgLang +
          ".jpg' alt='Instructions'><br><br>" +
          translator.t('instructions.step3') +
          '<br><br>',
        instructionsHeading +
          "<img src='images/Inst4_" +
          imgLang +
          ".jpg' alt='Instructions'><br><br>" +
  ...
  (function () {
    ...
    images[0] = 'images/Inst0_' + imgLang + '.jpg';
    images[1] = 'images/Inst1.jpg';
    images[2] = 'images/Inst2_' + imgLang + '.jpg';
    images[3] = 'images/Inst3_' + imgLang + '.jpg';
    images[4] = 'images/Inst4_' + imgLang + '.jpg';
